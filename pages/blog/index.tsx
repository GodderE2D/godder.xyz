    ...
    <div>
      <Head>
        ...
        <meta
          ...
          content="See GodderE2D's interesting list of blog posts in chronological order. Spoiler alert though, it may not be interesting to you."
        />
      ...
      <div className="flex-col justify-center flex items-center lg:flex-row">
        <div className="text-center">
          ...
          <p>
            Sometimes I post here for some reason, and no ones sees it.
            That&apos;s sad...
            <br />
